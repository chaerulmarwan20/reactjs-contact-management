...
function AddressEdit() {
  ...
  async function handleSubmit(e) {
    ...
    if (response.status === 200) {
      ...
      navigate({ pathname: `/dashboard/contacts/${id}` });
    } else {
  ...
  async function fetchAddress() {
    ...
    console.log("fetchAddress responseBody", responseBody);

    if (response.status === 200) {
      const address = responseBody?.data;
      ...
      await alertError(responseBody?.errors || "Failed to fetch address");
    }
  }
